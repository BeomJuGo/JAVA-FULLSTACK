...
const StaggeredMenu = ({
  ...
  const [textLines, setTextLines] = useState([menuLabel])
  ...
  React.useEffect(() => {
    setTextLines([open ? closeLabel : menuLabel])
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Main navigation header">
        ...
        <button
          ...
          type="button"
        >
          <span className="sm-toggle-label">{textLines[0]}</span>
              ...
              items.map((item, idx) => {
                ...
                return (
                  <li className="sm-panel-itemWrap" key={item.label + idx}>
                    <Component className="sm-panel-item" data-index={idx + 1} {...commonProps}>
